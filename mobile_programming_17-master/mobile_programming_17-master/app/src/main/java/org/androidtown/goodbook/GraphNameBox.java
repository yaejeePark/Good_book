...
public class GraphNameBox {
	...
	public static final int DEFAULT_NAMEBOX_COLOR            = Color.rgb(90,171,76);
	public static final int DEFAULT_NAMEBOX_MARGINTOP          = 200;
	public static final int DEFAULT_NAMEBOX_MARGINRIGHT       = 200;
	public static final int DEFAULT_NAMEBOX_PADDING          = 20;
	public static final int DEFAULT_NAMEBOX_TEXT_SIZE         = 50;
