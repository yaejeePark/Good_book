...
public class PhotoAdapter extends BaseAdapter {
    ...
    private ArrayList<PhotoItem> listViewItemList = new ArrayList<PhotoItem>();
    Context mContext;
    ...
    public void addItem(String title, String context, byte[] b_img, int id) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.custom_photo_list, parent, false);
        }

        // 화면에 표시될 View(Layout이 inflate된)으로부터 위젯에 대한 참조 획득
        ImageView imgPic = (ImageView) convertView.findViewById(R.id.ivPhotoPic);
        TextView tvTitle = (TextView) convertView.findViewById(R.id.tvPhotoTitle);
        TextView tvContext = (TextView) convertView.findViewById(R.id.tvPhotoContext);

        // Data Set(listViewItemList)에서 position에 위치한 데이터 참조 획득
        PhotoItem listViewItem = listViewItemList.get(position);
